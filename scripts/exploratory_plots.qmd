...
save_plot <- function(plot_obj, 
                      name,
                      figure_type = "exploratory",
                      subfolder, 
                      w = 6, 
                      h = 4) {

  dir.create(file.path("figures", figure_type, subfolder),
             showWarnings = FALSE, recursive = TRUE)

  ggsave(
    filename = file.path("figures", figure_type, subfolder, paste0(name, ".png")),
    plot = plot_obj,
    width = w,
    height = h,
    dpi = 600
...
for(n in names(exploratory_plots_soil)) {
  save_plot(
    plot_obj = exploratory_plots_soil[[n]],
    name = n, 
    figure_type = "exploratory",
    subfolder ="soil"
  )
...
ggplot(analysis_carbon, aes(final_C_Mg_per_ha)) +
  geom_histogram()
## Individually save the plot
save_plot(
  soil15,
  "final_C_distribution",
  figure_type = "exploratory",
  subfolder = "soil"
)
...
![](images/DAG_roots.png){width="462"}
...
for(n in names(exploratory_plots_roots)) {
  save_plot(
    plot_obj = exploratory_plots_roots[[n]],
    name = n, 
    figure_type = "exploratory",
    subfolder ="roots"
  )
...
for(n in names(exploratory_plots_rdm)) {
  save_plot(
    plot_obj = exploratory_plots_rdm[[n]],
    name = n, 
    figure_type = "exploratory",
    subfolder ="rdm"
  )
